!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!PARÁMETROS DE LAS SIGMOIDES PARA CONTROLAR EL PERFIL DE INTENSIDAD!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
ri(:) = ri_min + Li/(1+exp(ki*(this%spacez(:)-z0i))) !CALCULO DE LA PRIMERA SIGMOIDE

rig_max = 25e-6; !en metros
rig_min = 15e-6; !en metros
z0ig = 4e-3; !en metros
kig = 5e3; ! en 1/metros
Lig = rig_max-rig_min !PARÁMETRO AUXILIAR
sig_rig(:) = rig_min + Lig/(1+exp(kig*(this%spacez(:)-z0ig))) !CALCULO DE LA SEGUNDA SIGMOIDE
...
sig_r = 15e-6; !Desviación estandar en dirección transversal (radial) de la sobreionización del segundo pico (en metros). Este parámetro es sustituido por el vector de la segunda sigmoide sig_rig(:) en el cociente de exponenciales
rlion_cen(:) = ri(:); !ALMACENA LA PRIMERA SIGMOIDE EN EL VECTOR RLION_CEN (antes constante)
