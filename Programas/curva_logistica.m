...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
z = linspace(0,5); % Longitud de propagación del haz (mm)
...
% FUNCIÓN RADIO DEL CANAL
% Radio del canal interior con iones de Kr^8+
ri = @(z) ri_min + Li./(1+exp(ki.*(z-z0i)));   
% Radio del canal exterior con iones de Kr^8+
re = @(z) re_min + Le./(1+exp(ke.*(z-z0e)));   

% REPRESENTACIÓN GRÁFICA DE LAS CURVAS (SIGMOIDE)
f1 = fplot(ri,[0 5]);
