...
\end{equation}
con $x(t)$ el desplazamiento del electrón liberado, $p$ la cantidad de movimiento, $A_{L}$ el potencial vector del campo láser, $E_{L}$ el campo eléctrico del láser, y $\mathrm{c.c.}$ el complejo conjugado de la expresión.
