...
Actualmente existen fundamentalmente cuatro formas distintas de producir un haz de luz \acrshort{xuv} coherente, con aplicaciones en investigación básica y en nuevos desarrollos tecnológicos: la radiación sincrotrón, los láseres de electrones libres, los armónicos de alto orden, y la radiación betatrón. Las diferencias entre estas fuentes es muy diversa, y van desde las propiedades de la radiación emitida hasta el tamaño de los equipos y el coste de la inversión.

Por ejemplo, los métodos que generan la radiación sincrotrón y los láseres de electrones libres están basados en grandes aceleradores de partículas, y constituyen las fuentes de luz \acrshort{xuv} más habituales en instalaciones multidisplinares.

Tienen altos grados de coherencia espacial y tasas de repetición de \qty{100}{MHz}, que la convierte en ideal para recoger datos espectroscópicos de materiales, pero las duraciones del pulso por encima de \qty{10}{ps} y la relativamente baja coherencia temporal los convierte en mala elección para estudiar la dinámica de la materia por debajo del picosegundo.

En cambio, los láseres de electrones libres pueden generar pulsos \acrshort{xuv} ultracortos ($\sim \qty{10}{fs}$), con intensidad suficientemente altas para producir interacciones no lineales en la materia,que tiene múltiples aplicaciones en física. Sin embargo, las tasas de repetición capaces de conseguir son bajas en comparación con la radiación sincrotrón, normalmente \qtyrange{10}{120}{Hz} \autocite{Emma2010,Ishikawa2012}, representa un obstáculo considerable en la realización de mediciones.
