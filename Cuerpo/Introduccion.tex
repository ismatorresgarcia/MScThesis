...
La radiación betatrón como fuente de luz \acrshort{xuv} coherente es, probablemente, la más incipiente y, por tanto, menos desarrollada y estudiada de las formas de producción de rayos X coherentes que existe. La proposición y demostración de esta fuente de rayos X \autocite{Rousse2004,Kostyukov2004} tiene su origen en un mecanismo simulado numéricamente por Tajima y Dawson \autocite{Tajima1979}, en 1979, para acelerar electrones hasta velocidades relativistas.

Acelerar electrones hasta velocidades cercanas a la luz es un proceso complejo y costoso, pues requieren emplear aceleradores de partículas de grandes tamaños (basta observar el tamaño de las instalaciones del \acrshort{lcls}, en Livermore, California, o del \acrshort{esrf}, en Grenoble, Francia). Sin embargo, una forma de reducir el tamaño y coste de los futuros aceleradores utilizados en investigación y en desarrollos tecnológicos, consiste en emplear los campos eléctricos extremadamente intensos ($\sim \qty{100}{GV/m}$) generados en plasmas producidos por láseres para acelerar electrones. Este concepto de aceleradores es conocido como \emph{\acrfullpl{lwfa}} (como un acelerador sincrotrón en miniatura).
...
Las primeras observaciones experimentales del haz de electrones, a finales de la década de $1990$, \autocite{Modena1995,Umstadter1996} utilizaron pulsos láser de $\sim \qty{1}{ps}$, y desde entonces las energías del haz de electrones han aumentado hasta \qtyrange{60}{170}{MeV} \autocite{Mangles2004,Faure2004,Geddes2004} empleando pulsos láser ultracortos de $\sim \qty{100}{fs}$.


\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{Figuras/ch1_betaxrays.pdf}
